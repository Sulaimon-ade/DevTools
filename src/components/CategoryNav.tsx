...
export const CategoryNav: React.FC<CategoryNavProps> = ({
  ...
  return (
    <div className="w-full mb-8">
      ...
      <div className="hidden md:flex bg-white dark:bg-gray-800 rounded-xl p-2 shadow-sm border border-gray-100 dark:border-gray-700">
          ...
          return (
            ...
            >
              ...
              <span className={`
                ...
                ${isActive ? 'bg-blue-500 text-blue-100' : 'bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300'}
              `}>
                {category.count}
              </span>
            </button>
      ...
      <div className="md:hidden">
        <div className="relative">
          <select
            ...
            className="
              ...
              pl-12 pr-12 py-4 text-gray-900 dark:text-white font-medium shadow-sm 
        ...
        <div className="mt-3 px-4 py-2 bg-blue-50 dark:bg-blue-900/30 rounded-lg border border-blue-100 dark:border-blue-800">
